...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var getWeatherButton: MaterialButton
    ...
    private fun setupListeners() {
        ...
        findViewById<MaterialButton>(R.id.upload_photo_button).setOnClickListener {
            imagePickerLauncher.launch("image/*")
        }

        findViewById<MaterialButton>(R.id.theme_lavender).setOnClickListener { applyTheme("lavender") }
        findViewById<MaterialButton>(R.id.theme_mint).setOnClickListener { applyTheme("mint") }
        findViewById<MaterialButton>(R.id.theme_babyblue).setOnClickListener { applyTheme("babyblue") }
        findViewById<MaterialButton>(R.id.theme_pink).setOnClickListener { applyTheme("pink") }
        findViewById<MaterialButton>(R.id.email_feedback).setOnClickListener { sendFeedback() }
    }
    ...
    private fun applyTheme(themeName: String) {
        themes[themeName]?.let { theme ->
            ...
            buttons.forEach { buttonId ->
                findViewById<MaterialButton>(buttonId)?.let { button ->
    ...
    private fun showCityInput() {
        weatherDisplay.text = "Enter city for weather"
